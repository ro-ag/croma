...
fn default_unit_note_length_for_meter(meter: &Meter) -> NoteLengthFraction {
    match meter.kind {
...
fn ensure_default_unit_note_length(state: &mut FieldState, span: Span, options: ParseOptions) {
