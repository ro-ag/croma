...
| S6b | multi-voice (`<voice>`/`<backup>`), grace notes (`<grace>`), chords (`<chord/>`), mid-measure `<attributes>` changes | planned |
...
### S1/S2/S3/S4/S5a/S5b/S6a corpus metric (10k zenodo set)
